...
-- Dumpen data van tabel dominion.Cardset: ~7 rows (ongeveer)
/*!40000 ALTER TABLE `Cardset` DISABLE KEYS */;
INSERT IGNORE INTO `Cardset` (`name`) VALUES
	('big money'),
	('first game'),
	('interaction'),
	('size distortion'),
...
-- Dumpen data van tabel dominion.CardsetCard: ~10 rows (ongeveer)
/*!40000 ALTER TABLE `CardsetCard` DISABLE KEYS */;
INSERT IGNORE INTO `CardsetCard` (`cardset`, `cardName`) VALUES
...
-- Dumpen data van tabel dominion.Game: ~0 rows (ongeveer)
...
-- Dumpen data van tabel dominion.GamePlayer: ~0 rows (ongeveer)
